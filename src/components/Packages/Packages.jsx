...
const Packages = () => {
  ...
  return (
    <>
      <div className="flex flex-col text-center justify-center items-center mt-16 w-full">
      <Link to="/packages"><h1 className="text-3xl my-2">
          <b>Packages</b>
        </h1></Link>
        <hr className="mb-8 w-1/3" />
      </div>
      <div className="lg:mx-16 md:mx-8 text-sm flex items-center justify-center mb-16">
